...
void AGameWorld::ImportTileSets() {
    //Base terrain types:
...
void AGameWorld::UpdateRhombVision(
    int32 X, int32 Y,
...
void AGameWorld::UpdateTileVision(int32 X, int32 Y, VisionType vision) {
    X = abs((X) % map.Width);
    Y = abs((Y) % map.Height);
